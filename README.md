...
class AboutMe extends Developer
{
    ...
    return [
            'backend' => ['PHP', 'Laravel', 'Livewire', 'MySQL', 'API Development', 'PostgreSQL', 'Redis', 'WebSockets'],
            'frontend' => ['JavaScript', 'Vue.js', 'React', 'Tailwind CSS', 'HTML5/CSS3', 'UX/UI Design', 'Prototyping', 'Wireframing', 'Design Systems',],
            'tools' => ['Git & GitHub', 'Docker', 'AWS', 'Linux', 'VS Code'],
            'testing' => ['PHPUnit', 'Pest', 'Test-Driven Development (TDD)','Feature & Unit Testing', 'Browser Testing', 'Code Quality Tools', 'Performance Optimization'],
            'devops_cloud' => ['Docker', 'AWS (EC2, S3, RDS)', 'Forge & Envoyer', 'CI/CD Pipelines', 'Nginx', 'Linux Server Administration', 'GitHub Actions', 'Shell Scripting', 'Monitoring & Logging']
        ];
    }
