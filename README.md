 ...
 * @version 1.0
 */
final class AboutMe extends FullStackPHP_Developer implements 
    BackendTechnologies,
    FrontendTechnologies, 
    DesignExpertise,
    DevOpsTools,
    DevelopmentPrinciples
{
    ...
    public function __construct(
        ...
        private Location $location = new Location('City, Country'),
        private array $certifications = ['AWS Certified', 'Laravel Certified']
    ) {}
